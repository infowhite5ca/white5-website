...
const CAMPAIGN_NAME = "White5 | Window & Screen Cleaning | Calgary";
...
export async function createPausedWindowCampaignWithBudgetFix(request, env) {
  ...
  try {
    ...
    const result = await createPausedWindowCampaign(request, env);
